...
function InputForm() {
  ...
  const handleSubmit = (event) => {
    ...
    const result =
      (10 * weight + 6.25 * height - 5 * age + (isMale ? 5 : -165)) * activity;
        ...
        <div className="calculator__container">
          <div className="calculator__container-inner">
            ...
            <p className="calculator__description">
              Use this calculator to estimate how many calories you should eat
              every day to lose weight, maintain, and gain muscle.
            </p>
          </div>
        </div>
        <div className="calculator__container-lowerouter">
          <div className="calculator__container-lowerinner">
            <form className="form" onSubmit={handleSubmit}>
              <div className="gender__container">
                ...
                <div className="gender__container-right">
                  <input
                    ...
                    checked
                  />
                  <label className="gender__radio" for="male">
                    Male
                  </label>
                  <input
                    type="radio"
                  ...
                  />
                  <label className="gender__radio female-radio" for="female">
                    Female
                  </label>
                </div>
              </div>
              ...
              <div>
                <label className="activity__title" for="activity">
                  Activity Level
                </label>
                <Select
                  className="activity__input"
                  options={options}
                  onChange={(values) => setActivity(values[0].value)}
                />
              </div>
              <div className="btn-container">
                <div>
                  <button
                    className="results-btn btn-left"
                    type="submit"
                ...
                <div>
                  <button className="results-btn" onClick={(e) => onClear(e)}>
                    Clear
                  </button>
                </div>
              </div>
